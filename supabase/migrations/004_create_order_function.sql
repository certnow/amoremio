...
begin
  ...
  insert into public.orders (
    ...
    v_customer_id, v_name, p_customer->>'phone', v_email, v_address,
    0, v_shipping, v_shipping, 'pending', nullif(trim(coalesce(p_notes, '')), '')
  ...
  loop
    ...
    select id, name, price, promotional_price, stock, active
    into v_product
    ...
    insert into public.order_items (
      ...
      v_order_id, v_product_id, v_variant_id, v_product.name,
      v_variant_label, v_quantity, v_unit_price
    );
